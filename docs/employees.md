...
|---|---|---|
| `{{hoursPerWeek}}` | Pracovní podmínky | Contracted hours/week — stored row value, else HPP → 40, PPP → 20, DPP → blank (default added v5.7.0; see [contracts.md](contracts.md#row-sourced-template-variables--probationend-date-conditionals-2026-04-29)) |
