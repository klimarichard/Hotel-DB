...
Sekce **Návody** je knihovna instruktážních materiálů pro zaměstnance – PDF návody a odkazy na externí zdroje (například sdílenou složku na Google Drive nebo video) roztříděné do **kategorií** (např. Recepce, Mzdy). Přístup se řídí oprávněním **„Zobrazit Návody"**, které mají v praxi přidělené všichni uživatelé, takže položku **Návody** v levém menu vidí téměř každý – pokud ji nevidíte, obraťte se na administrátora.

> 📷 *(Místo pro snímek obrazovky: stránka Návody s kategoriemi a seznamem návodů)*

### Otevření Návodů a procházení kategorií

1. V levém menu klikněte na položku **Návody**.
2. Zobrazí se stránka rozdělená do **kategorií**. Pod názvem každé kategorie je seznam jejích návodů.
3. U každého návodu vidíte ikonu podle typu – 📄 pro PDF soubor, 🔗 pro odkaz –, jeho **název** a případně krátký **popis**.

> 📝 Pokud v některé kategorii zatím žádný návod není, zobrazí se u ní text „Žádné návody." Pokud v celé sekci zatím nejsou žádné kategorie, zobrazí se místo seznamu jen informační hláška.
...
Uživatelé s oprávněním **„Spravovat návody"** (typicky administrátor nebo ředitel) navíc vidí tlačítka pro vytváření a úpravu kategorií i jednotlivých návodů.

**Kategorie**

1. Novou kategorii založíte tlačítkem **Nová kategorie** nahoře na stránce – zadáte jen její **název** a potvrdíte tlačítkem **Uložit**.
2. U existující kategorie použijte tlačítko **Přejmenovat** (změna názvu) nebo **Smazat**.

> ⚠️ Kategorii, ve které jsou ještě nějaké návody, nelze smazat. Nejprve všechny návody v ní přesuňte do jiné kategorie (úpravou návodu) nebo je smažte – teprve poté lze prázdnou kategorii odstranit.

**Návody**

1. Nový návod založíte tlačítkem **Nový návod** nahoře na stránce (tlačítko je dostupné, jen pokud už existuje alespoň jedna kategorie).
...
4. Vyberete **kategorii**, do které návod patří.
...
- Existující návod upravíte tlačítkem **Upravit** (otevře stejný formulář jako při zakládání, předvyplněný) nebo smažete tlačítkem **Smazat** – smazání je nevratné.
- Pořadí návodů **v rámci kategorie** změníte šipkami **↑** a **↓** u každého řádku – šipka nahoru přesune návod o jednu pozici výš, šipka dolů o jednu pozici níž. Pořadí mezi kategoriemi navzájem se takto neřídí, kategorie samotné se řadí v pořadí, v jakém byly vytvořeny.

> 📷 *(Místo pro snímek obrazovky: formulář Nový návod s výběrem typu PDF/Odkaz)*
