...
export const PERMISSION_CATALOG = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "recepce.ambiance.lobbyBar.manage", label: "Ambiance — Spravovat lobby bar" },
      { key: "recepce.ambiance.odvody.view", label: "Ambiance — Odvody" },
      { key: "recepce.ambiance.odvody.manage", label: "Ambiance — Spravovat odvody" },
      ...
      { key: "recepce.superior.odvody.view", label: "Superior — Odvody" },
      { key: "recepce.superior.odvody.manage", label: "Superior — Spravovat odvody" },
      ...
      { key: "recepce.amigo.terminal.manage", label: "Amigo & Alqush — Spravovat terminál" },
      { key: "recepce.amigo.odvody.view", label: "Amigo & Alqush — Odvody" },
      { key: "recepce.amigo.odvody.manage", label: "Amigo & Alqush — Spravovat odvody" },
      ...
      { key: "recepce.ankora.odvody.view", label: "Ankora — Odvody" },
      { key: "recepce.ankora.odvody.manage", label: "Ankora — Spravovat odvody" },
    ],
  },
  {
    group: "Tabulky",
