...
export const PERMISSION_CATALOG = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "recepce.ambiance.protokol.manage", label: "Ambiance — Spravovat podpisy" },
      ...
      { key: "recepce.superior.protokol.manage", label: "Superior — Spravovat podpisy" },
      ...
      { key: "recepce.amigo.protokol.manage", label: "Amigo & Alqush — Spravovat podpisy" },
      ...
      { key: "recepce.ankora.protokol.manage", label: "Ankora — Spravovat podpisy" },
