...
export const PERMISSION_CATALOG = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "recepce.ambiance.odvody.manage", label: "Ambiance – Připravit odvod" },
      ...
      { key: "recepce.superior.odvody.manage", label: "Superior – Připravit odvod" },
      ...
      { key: "recepce.amigo.odvody.manage", label: "Amigo & Alqush – Připravit odvod" },
      ...
      { key: "recepce.ankora.odvody.manage", label: "Ankora – Připravit odvod" },
