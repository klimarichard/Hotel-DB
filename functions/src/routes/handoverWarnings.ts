...
/**
 * "Nenavazující předání" — non-consecutive handover warnings. Generated by the
 * handover sign flow (functions/src/routes/handovers.ts → syncChainWarning) when
 * a shift's Předal signer differs from the previous shift's Převzal signer. Read
 * (acknowledged) in place via a `read` flag, mirroring routes/alerts.ts.
 */
