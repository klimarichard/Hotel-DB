...
- **Souhrnný řádek** nad tabulkou zobrazuje tři hodnoty za zvolený rok:
  - **Nárok** – roční nárok zaměstnance na dovolenou (v hodinách).
  - **Čerpáno** – kolik hodin dovolené už bylo v daném roce vyčerpáno.
  - **Zůstatek** – kolik hodin zbývá (Nárok mínus Čerpáno). Je-li záporný (zaměstnanec vyčerpal víc, než měl nárok), zobrazí se **červeně**.
