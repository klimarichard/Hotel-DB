# Příručka — Zaměstnanec

HPM Intranet je interní HR systém společností Special Tours Prague (STP) a Hotel Property Management (HPM). Jako zaměstnanec v něm uvidíte přehled provozu, svůj plán směn, dovolenou a svůj profil. Tato příručka popisuje jen ty části aplikace, ke kterým máte přístup.
...
- V záhlaví každého vyskakovacího okénka průvodce je vedle čítače kroků (např. „Krok 2 z 5") zobrazen název aktuální sekce. Pomocí tlačítek **„‹ Předchozí sekce"** a **„Další sekce ›"** můžete přeskočit celou sekci najednou — praktické, pokud chcete rychle přejít na část, která vás zajímá.
...
Žádosti o dovolenou a jejich přehled.
...
- **Schválené dovolené (všichni zaměstnanci)** — přehled schválených dovolených kolegů.
...
- **Dovolená:** pod sekcí **Pracovní poměr** se vám může zobrazovat sbalitelná sekce **„Dovolená"** s vaší vlastní bilancí dovolené za kalendářní rok, v hodinách. Obsahuje přepínač roku (otevře se na aktuálním roce; dopředu se posunout nelze, zpět nejdále do roku 2022 – u roku bez údajů to sekce napíše); souhrn **Loňská** / **Letošní** / **Nárok** (= Loňská + Letošní) / **Čerpáno** / **Zůstatek** (záporný se zobrazí červeně); a tabulku čerpání po měsících **1–12** se sloupcem **CELKEM**. Ručně upravený měsíc je označen hvězdičkou **„*"** s vysvětlivkou *„Ručně upraveno"* po najetí myší. Hodnoty se doplňují automaticky, jakmile je příslušné mzdové období uzamčeno. Sekce je čistě **informativní** – nic v ní upravit nejde; případnou opravu provede administrátor na vaší kartě zaměstnance v Zaměstnancích. Sekce se zobrazí, jen pokud vám administrátor přidělí oprávnění **„Zobrazit vlastní zůstatek dovolené"** – ve výchozím stavu ho nemá nikdo, takže bez jeho přidělení se sekce na stránce vůbec neobjeví.
