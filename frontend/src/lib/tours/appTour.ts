...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { hideOnMobile: true, permission: "dokumenty.manage", addedInVersion: 18, anchor: "dokumenty-manage", route: "/dokumenty", title: "Správa dokumentů", body: "Tlačítkem Nový dokument vytvoříte dokument a jeho obsah napíšete v editoru. Tlačítkem Nastavit určíte vlastní proměnné – místa, která ten, kdo dokument tiskne, vyplní podle potřeby. Dokument můžete zařadit do sekce (Ambiance, Superior, Amigo & Alqush, Ankora, TEMP) – pak jej uvidí jen ti, kdo mají oprávnění pro danou sekci. Dokument bez sekce uvidí každý, kdo má přístup do Dokumentů.", placement: "bottom" },
