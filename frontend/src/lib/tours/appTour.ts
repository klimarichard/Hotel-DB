...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { hideOnMobile: true, permission: "dokumenty.manage", addedInVersion: 21, anchor: "dokumenty-manage", route: "/dokumenty", title: "Správa dokumentů", body: "Tlačítkem Nový dokument vytvoříte dokument a jeho obsah napíšete v editoru. Tlačítkem Nastavit určíte vlastní proměnné – místa, která ten, kdo dokument tiskne, vyplní podle potřeby. Zaškrtávátkem Veřejný určíte, kdo dokument uvidí: veřejný dokument uvidí každý, kdo má přístup do Dokumentů, neveřejný jen ti, kdo mohou dokumenty spravovat. Nový dokument je vždy neveřejný, dokud jej sami nezveřejníte.", placement: "bottom" },
