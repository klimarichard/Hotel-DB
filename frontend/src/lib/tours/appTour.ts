...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { permission: "contracts.sign", addedInVersion: 15, anchor: "emp-contract-sign", route: DEMO_EMP, reveal: ["emp-tab-history"], title: "Podepsaná smlouva - nově i s prohlášením", body: "Tlačítkem Nahrát podepsanou smlouvu nahrajete naskenovanou podepsanou verzi. Nově si vyberete ze dvou možností: „Smlouva“ nahraje celý soubor jako smlouvu (jako dosud), „Smlouva + prohlášení“ naskenovaný soubor rozdělí - první strany uloží jako smlouvu a zbylé strany jako prohlášení poplatníka do Dalších dokumentů. Aplikace se zeptá, kolik prvních stran tvoří smlouvu. Velké skeny se navíc automaticky zmenší.", placement: "left" },
  ...
  { permission: "contracts.generate", addedInVersion: 15, anchor: "emp-doc-generate", route: DEMO_EMP, reveal: ["emp-tab-docs"], title: "+ Generovat dokument (dříve + Adhoc dokument)", body: "Tlačítko + Adhoc dokument se přesunulo ze záložky Historie pracovního poměru sem a jmenuje se nyní + Generovat dokument. Vytvoříte jím samostatný dokument (např. Multisport nebo Hmotnou odpovědnost). Samostatná sekce Ad hoc smlouvy zmizela - tyto dokumenty teď najdete rovnou v seznamu níže, spolu s nahranými dokumenty. V Historii pracovního poměru tak zůstává jen samotná historie pracovního poměru.", placement: "bottom" },
