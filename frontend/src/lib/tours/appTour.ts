...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { hideOnMobile: true, permission: "dokumenty.manage", addedInVersion: 21, anchor: "dokumenty-manage", route: "/dokumenty", title: "Správa dokumentů", body: "Tlačítkem Nový dokument vytvoříte dokument a jeho obsah napíšete v editoru. U každého dokumentu volíte Viditelnost: Veřejný uvidí každý, kdo má přístup do Dokumentů, Neveřejný jen ti, kdo mají oprávnění zobrazit i neveřejné dokumenty, a Skrytý jen správci. Nový dokument je vždy Skrytý, dokud viditelnost nezměníte.", placement: "bottom" },
