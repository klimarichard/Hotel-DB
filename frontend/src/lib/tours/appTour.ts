...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { permission: ["employment.manage", "documents.view"], addedInVersion: 7, anchor: "emp-doc-tax-declaration", route: DEMO_EMP, reveal: ["emp-tab-history"], title: "Prohlášení poplatníka", body: "Tlačítkem Prohlášení poplatníka vygenerujete vyplněné prohlášení poplatníka daně (PDF) - nejprve zadáte zdaňovací období.", placement: "bottom" },
