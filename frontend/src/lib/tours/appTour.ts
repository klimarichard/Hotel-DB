...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  // ── Směny (/smeny) ──────────────────────────────────────────────────────────
  { section: SECTIONS.shifts, permission: ["shifts.view.all", "shifts.view.self"], anchor: "shift-month-nav", route: DEMO_SHIFTS, title: "Výběr měsíce", body: "Šipkami přecházíte mezi měsíci, tlačítkem DNES se vrátíte na aktuální měsíc. V tabulce je rozpis směn.", placement: "bottom" },
