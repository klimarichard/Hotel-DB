...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  // ── Směny (/smeny) ──────────────────────────────────────────────────────────
  { permission: "shifts.view.self", anchor: "shift-month-nav", route: DEMO_SHIFTS, title: "Výběr měsíce", body: "Šipkami přecházíte mezi měsíci, tlačítkem Dnes zpět na aktuální. V plánu vidíte své směny.", placement: "bottom" },
  ...
  { permission: "shifts.freeShift.claim", anchor: "shift-my-requests", route: DEMO_SHIFTS, title: "Žádost o volnou směnu", body: "Volné portýrské směny jsou zobrazeny pod rozpisem směn. Můžete o ně požádat dvojklikem na danou volnou směnu.", placement: "top" },
