...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { permission: ["recepce.ambiance.odvody.manage", "recepce.superior.odvody.manage", "recepce.amigo.odvody.manage", "recepce.ankora.odvody.manage"], addedInVersion: 20, hideOnMobile: true, anchor: "odvody-open", route: DEMO_PROTOKOL, title: "Příprava odvodu", body: "V sekci Účty vedle tlačítka + Přidat účet najdete tlačítko „Připravit odvod“, kterým otevřete formulář odvodu za zvolený měsíc. Spočítáte v něm bankovky CZK a EUR, které jdou do banky – berou se z trezoru, a co v něm nestačí, doplní se z kasy. Zaškrtnete účty, které už jsou zavedené v účetnictví, a opíšete hodnoty z Protelu (CZK cash, CZK cash depozit, EUR cash, EUR cash depozit). Částky k odvedení se dopočítají samy. U hotelu Amigo & Alqush zadáváte hodnoty za oba hotely a navíc poměr, podle kterého se rozdělí zbylá hotovost.", placement: "bottom" },
  { permission: ["recepce.ambiance.protokol.view", "recepce.superior.protokol.view", "recepce.amigo.protokol.view", "recepce.ankora.protokol.view"], addedInVersion: 20, hideOnMobile: true, anchor: "odvody-settle", route: DEMO_PROTOKOL, title: "Provedení odvodu", body: "Uložený odvod přidá do Účtů zamčený řádek „odvod + účty“. Na poslední noční směně v měsíci se u něj objeví tlačítko Provést odvod – tím řádek z protokolu zmizí a odečtou se odváděné bankovky EUR. Teprve tímto krokem peníze z protokolu skutečně odejdou, a zpět už to vzít nelze.", placement: "left" },
