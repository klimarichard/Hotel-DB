...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { permission: "shifts.view.all", anchor: "shift-grid", route: "/smeny", title: "Celý plán směn", body: "Tabulka zobrazuje měsíční plán směn pro recepci. Kódy (DA, NS, X…) označují typ směny nebo volno; legenda je pod tabulkou.", placement: "bottom" },
  ...
  { permission: "shifts.cells.editOwnX", anchor: "shift-grid", route: "/smeny", title: "Zadání vlastního volna (X)", body: "Do svého řádku můžete po vytvoření plánu směn na další měsíc přímo zapsat volno (X). Maximální počet pro zaměstnance na plný úvazek je 8 X, pro poloviční úvazek 13 X. Pokud potřebujete více dní, můžete požádat o výjimku (po zadání devátého X se vám automaticky zobrazí okno s žádostí o X navíc, kam napíšete odůvodnění). Admin poté žádost schválí, nebo zamítne (také s odůvodněním). Pokud potřebujete zadat 7 a více dní v kuse, požádejte o dovolenou.", placement: "bottom" },
  { permission: "shifts.cells.edit", anchor: "shift-grid", route: "/smeny", title: "Vyplňování plánu", body: "V tabulce směn můžete kliknutím do buňky upravovat směny všech zaměstnanců.", placement: "bottom" },
  { permission: "shifts.changeRequest.submit", anchor: "shift-my-requests", route: "/smeny", title: "Žádost o změnu směny", body: "Když je plán směn již hotový, žádost o změnu podáte dvojklikem na danou buňku. Popište, o jakou změnu jde (stačí např. „vyměnit s …“). Admin změny schvaluje nebo zamítá. Stav žádosti vidíte v sekci Moje žádosti.", placement: "top" },
  { permission: "shifts.freeShift.claim", anchor: "shift-my-requests", route: "/smeny", title: "Žádost o volnou směnu", body: "Volné portýrské směny jsou zobrazeny pod rozpisem směn. Můžete o ně požádat dvojklikem na danou volnou směnu.", placement: "top" },
  ...
  { permission: "shifts.plan.edit", anchor: "shift-edit-deadlines", route: "/smeny", title: "Automatizace plánování", body: "Zde nastavíte termíny plánu (otevření, uzávěrka, publikování).", placement: "bottom" },
  { permission: "shifts.plan.transition", anchor: "shift-transitions", route: "/smeny", title: "Změna stavu plánu", body: "Tímto tlačítkem změníte stav tabulky směn (posloupnost stavů je Vytvořený → Otevřený → Uzavřený → Publikovaný). Stav plánu určuje, kdo do něj smí zapisovat.", placement: "bottom" },
  ...
  { permission: "shifts.plan.delete", anchor: "shift-delete", route: "/smeny", title: "Smazání plánu", body: "Tlačítkem Smazat plán nevratně odstraníte celý měsíční plán (program se ujistí, že to je opravdu to, co chcete udělat).", placement: "bottom" },
  { permission: "shifts.planEmployees.manage", anchor: "shift-add-employee", route: "/smeny", title: "Přidání zaměstnance", body: "Tlačítkem Přidat zaměstnance určujete, kdo se v plánu zobrazuje.", placement: "bottom" },
  { permission: "shifts.mod.manage", anchor: "shift-grid", route: "/smeny", title: "MOD", body: "V tomto řádku můžete přiřadit manažerům MOD pro daný den.", placement: "bottom" },
  { permission: "shifts.xAllowance.manage", anchor: "shift-grid", route: "/smeny", title: "Limit X", body: "Můžete nastavit maximální počet volných dnů pro každého zaměstnance v plánu.", placement: "bottom" },
  { permission: "shifts.freeShift.manage", anchor: "shift-grid", route: "/smeny", title: "Správa volných DPA směn", body: "DPQ, NPQ a NPA směny se jako volné zobrazují automaticky, pokud nejsou nikomu přiřazeny. Pro DPA směny můžete označit dny, o které si mohou zaměstnanci zažádat.", placement: "bottom" },
  { permission: "shifts.export", anchor: "shift-export", route: "/smeny", title: "Export plánu", body: "Tabulku směn můžete exportovat do CSV nebo PDF.", placement: "bottom" },
