...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { permission: "shifts.freeShift.claim", anchor: "shift-free", route: DEMO_SHIFTS_PUBLISHED, title: "Žádost o volnou směnu", body: "Volné portýrské směny jsou zobrazeny pod rozpisem směn. Můžete o ně požádat dvojklikem na danou volnou směnu.", placement: "top" },
