...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  // ── Směny (/smeny) ──────────────────────────────────────────────────────────
  { permission: "shifts.view.self", anchor: "shift-month-nav", route: DEMO_SHIFTS, title: "Výběr měsíce", body: "Šipkami přecházíte mezi měsící, tlačítkem DNES se vrátíte na aktuální měsíc. V tabulce je rozpis směn.", placement: "bottom" },
  { permission: "shifts.view.all", anchor: "shift-grid", route: DEMO_SHIFTS, title: "Celý plán směn", body: "Tabulka zobrazuje měsíční plán směn pro recepci. Kódy (DA, NS, X…) označují typ směny nebo volno; legenda je pod tabulkou.", placement: "bottom" },
  { permission: "shifts.counterTable.view", anchor: "shift-grid", route: DEMO_SHIFTS, title: "Tabulka obsazenosti", body: "Pod plánem je souhrnná tabulka obsazenosti — počty lidí na pozicích pro každý den.", placement: "bottom" },
  { permission: "shifts.cells.editOwnX", anchor: "shift-grid", route: DEMO_SHIFTS, title: "Zadání vlastního volna (X)", body: "Do svého řádku můžete po vytvoření plánu směn na další měsíc přímo zapsat volno (X). Maximální počet pro zaměstnance na plný úvazek je 8 X, pro poloviční úvazek 13 X. Pokud potřebujete více dní, můžete požádat o výjimku (po zadání devátého X se vám automaticky zobrazí okno s žádostí o X navíc, kam napíšete odůvodnění). Admin poté žádost schválí, nebo zamítne (také s odůvodněním). Pokud potřebujete zadat 7 a více dní v kuse, požádejte o dovolenou.", placement: "bottom" },
  { permission: "shifts.cells.edit", anchor: "shift-grid", route: DEMO_SHIFTS, title: "Vyplňování plánu", body: "V tabulce směn můžete kliknutím do buňky upravovat směny všech zaměstnanců.", placement: "bottom" },
  { permission: "shifts.changeRequest.submit", anchor: "shift-my-requests", route: DEMO_SHIFTS, title: "Žádost o změnu směny", body: "Když je plán směn již hotový, žádost o změnu podáte dvojklikem na danou buňku. Popište, o jakou změnu jde (stačí např. „vyměnit s …“). Admin změny schvaluje nebo zamítá. Stav žádosti vidíte v sekci Moje žádosti.", placement: "top" },
  { permission: "shifts.freeShift.claim", anchor: "shift-my-requests", route: DEMO_SHIFTS, title: "Žádost o volnou směnu", body: "Volné portýrské směny jsou zobrazeny pod rozpisem směn. Můžete o něm požádat dvojklikem na danou volnou směnu.", placement: "top" },
  ...
  { permission: "shifts.freeShift.manage", anchor: "shift-grid", route: DEMO_SHIFTS, title: "Správa volných DPA směn", body: "DPQ, NPQ a NPA směny se jako volné zobrazují automaticky, pokud nejsou nikomu přiřazeny. Pro DPA směny můžete označit dny, o které si mohou zaměstnanci zažádat.", placement: "bottom" },
