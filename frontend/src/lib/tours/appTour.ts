...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { permission: "recepce.ambiance.lobbyBar.view", addedInVersion: 13, hideOnMobile: true, anchor: "lobbybar-add", route: DEMO_LOBBY_BAR, title: "Prodej z lobby baru", body: "Tímto tlačítkem zapíšete prodej: datum, položku z ceníku, počet kusů, měnu a kdo prodal. Cena, provize i částka do společné se dopočítají samy.", placement: "bottom" },
  { permission: "recepce.ambiance.lobbyBar.view", addedInVersion: 13, hideOnMobile: true, anchor: "lobbybar-cenik", route: DEMO_LOBBY_BAR, title: "Ceník položek", body: "Vpravo je ceník. Každá položka má cenu v korunách i v eurech – prodej se vždy počítá v měně, ve které host zaplatil, nic se nepřepočítává.", placement: "left" },
