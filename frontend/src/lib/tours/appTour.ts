...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  { permission: "shifts.changeRequest.submit", excludeIfPermission: "shifts.plan.transition", addedInVersion: 10, anchor: "shift-change-request-modal", route: DEMO_SHIFTS_CHANGE_REQUEST, title: "Žádost o změnu směny", body: "V publikovaném plánu směn můžete požádat o změnu dvojklikem na příslušnou buňku. Otevře se vám tento dialog, kde můžete vybrat typ směny, na který chcete svoji stávající směnu vyměnit, požádat o výměnu směny s kolegou (stačí požádat pouze jednou, není potřeba žádat podruhé u kolegy, se kterým chcete měnit), napsat počet hodin, který jste odpracovali (pokud jste např. museli odejít dřív), požádat o smazání, nebo napsat textový požadavek, pokud potřebujete požádat o něco jiného, než nabízí připravené možnosti.", placement: "left" },
