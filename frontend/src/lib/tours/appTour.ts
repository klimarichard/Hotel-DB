...
export const APP_TOUR_STEPS: TourStep[] = [
  ...
  // DRAFT COPY (needs user review): step spotlights the redesigned change-request
  // modal itself. The modal is auto-opened on the dedicated demo route
  ...
  { permission: "shifts.changeRequest.submit", excludeIfPermission: "shifts.plan.transition", addedInVersion: 10, anchor: "shift-change-request-modal", route: DEMO_SHIFTS_CHANGE_REQUEST, title: "Žádost o změnu směny", body: "Když je plán směn už publikovaný, otevřete si dvojklikem na svou buňku toto okno a požádáte o změnu směny. Vyberte typ nebo počet hodin, případně směnu smažte či ji vyměňte s kolegou — nebo popište vlastní požadavek v poli „Jiné“. Žádost odešlete tlačítkem Odeslat žádost; admin ji poté schválí nebo zamítne.", placement: "left" },
