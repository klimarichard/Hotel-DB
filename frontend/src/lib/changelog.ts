...
export const CHANGELOG: readonly ChangelogEntry[] = [
  {
    ...
    date: "2026-08-27",
    changes: [
      "Šablony smluv: Nová proměnná Rodné číslo a nový typ odrážek se čtverečky k zaškrtnutí.",
    ],
  },
  {
    version: "5.11.12",
    date: "2026-08-20",
    changes: [
      "České popisky u automatických úloh.",
    ],
  },
  {
    version: "5.11.11",
  ...
  },
  {
    ...
    date: "2026-08-19",
    changes: [
      "Dovolená: Změna formátu tabulky čerpání.",
    ],
  },
  {
    version: "5.11.9",
    date: "2026-08-19",
    changes: [
      "Uživatelé: V tabulce uživatelů je nyní vidět poslední aktivita.",
    ],
  },
  {
    version: "5.11.8",
    date: "2026-08-19",
    changes: [
      "Předávací protokol: Lepší ochrana proti současnému upravování dvěma uživateli.",
    ],
  },
  {
    version: "5.11.7",
  ...
  },
  {
    ...
    date: "2026-08-18",
    changes: [
      "Možnost manuálního spouštění všech automatizovaných úloh.",
    ],
  },
  {
    version: "5.11.5",
    date: "2026-08-18",
    changes: [
      "Drobné opravy automatických úloh.",
    ],
  },
  {
    version: "5.11.4",
    date: "2026-08-18",
    changes: [
      "Zaměstnanci: Úpravy zaměstnanců před nástupem.",
    ],
  },
  {
    version: "5.11.3",
    date: "2026-08-18",
    changes: [
      "Uživatelé: Změny v propojení zaměstnanců s uživatelskými účty.",
    ],
  },
  {
    version: "5.11.2",
    date: "2026-08-17",
    changes: [
      "Upozornění: Nová záložka pro systémové úlohy.",
    ],
  },
  {
    version: "5.11.1",
  ...
  },
  {
    ...
    date: "2026-08-16",
    changes: [
      "Tabulky: Nová tabulka pro objednávky z Hygopu.",
    ],
  },
  {
    version: "5.10.1",
    date: "2026-08-16",
    changes: [
      "Předávací protokol: Změny v historii úprav.",
    ],
  },
  {
    version: "5.10.0",
    date: "2026-08-15",
    changes: [
      "Dovolená: Tabulka čerpání dovolené.",
    ],
  },
  {
    version: "5.9.3",
    date: "2026-08-15",
    changes: [
      "Zaměstnanci: Změny v tabulce dovolené.",
    ],
  },
  {
    version: "5.9.2",
  ...
  },
  {
    ...
    date: "2026-08-13",
    changes: [
      "Zaměstnanci: drobné úpravy pro vytváření dodatků, drobné změny UI",
    ],
  },
  {
    version: "5.8.3",
    date: "2026-08-13",
    changes: [
      "Zaměstnanci: Úprava zobrazení historie",
    ],
  },
  {
    version: "5.8.2",
    date: "2026-08-13",
    changes: [
      "Skrytí některých prvků UI v mobilním rozhraní.",
    ],
  },
  {
    version: "5.8.1",
  ...
  },
  {
    ...
    date: "2026-08-12",
    changes: [
      "Směny: Import starších rozpisů, nový typ směny REZ, další drobné úpravy.",
    ],
  },
  {
    version: "5.7.0",
    date: "2026-08-06",
    changes: [
      "Dovolená: Zobrazení zůstatku dovolené při vytváření směn.",
    ],
  },
  {
    version: "5.6.1",
    date: "2026-08-06",
    changes: [
      "Šablony smluv: Oprava generování pracovních smluv.",
    ],
  },
  {
    version: "5.6.0",
  ...
  },
  {
    ...
    date: "2026-08-05",
    changes: [
      "Tabulky: Doplněny součtové řádky.",
    ],
  },
  {
    version: "5.5.1",
  ...
  },
  {
    ...
    date: "2026-08-04",
    changes: [
      "Drobné funkční a bezpečnostní opravy.",
    ],
  },
  {
    version: "5.4.2",
    date: "2026-08-04",
    changes: [
      "Směny: Zobrazení počtu MOD směn před otevřením plánu.",
    ],
  },
  {
    version: "5.4.1",
    date: "2026-08-04",
    changes: [
      "Dokumenty: Oprava nepovinných proměnných.",
    ],
  },
  {
    version: "5.4.0",
    date: "2026-08-03",
    changes: [
      "Faktury: Změny ve formátování depozitních faktur. Faktury bez diakritiky.",
    ],
  },
  {
    version: "5.3.4",
    date: "2026-08-03",
    changes: [
      "Zaměstnanci: Úprava zobrazení u ukončených smluv.",
    ],
  },
  {
    version: "5.3.3",
    date: "2026-08-03",
    changes: [
      "Oprávnění: Drobné změny v matici oprávnění.",
    ],
  },
  {
    version: "5.3.2",
    date: "2026-08-03",
    changes: [
      "Dokumenty: Nový systém viditelnosti dokumentů.",
    ],
  },
  {
    version: "5.3.1",
    date: "2026-08-02",
    changes: [
      "Tmavý režim při načítání stránky.",
    ],
  },
  {
    version: "5.3.0",
  ...
  },
  {
    ...
    date: "2026-07-25",
    changes: [
      "Dokumenty: Nové typy vlastních proměnných.",
    ],
  },
  {
    version: "5.2.0",
    date: "2026-07-24",
    changes: [
      "Dokumenty: větší flexibilita vlastních proměnných.",
    ],
  },
  {
    version: "5.1.2",
  ...
  },
  {
    ...
    date: "2026-07-23",
    changes: [
      "Recepce: formátování odvodů pro tisk.",
    ],
  },
  {
    version: "5.1.0",
    date: "2026-07-23",
    changes: [
      "Recepce: Možnost připravit odvody pro konec měsíce.",
    ],
  },
  {
    version: "5.0.4",
    date: "2026-07-22",
    changes: [
      "Drobné opravy v textových editorech.",
    ],
  },
  {
    version: "5.0.3",
  ...
  },
  {
    ...
    date: "2026-07-22",
    changes: [
      "Faktury: změna ve zobrazení uložených číselníků.",
    ],
  },
  {
    version: "5.0.1",
  ...
  },
  {
    ...
    date: "2026-07-21",
    changes: [
      "Dokumenty: možnost duplikovat dokument.",
    ],
  },
  {
    version: "4.15.0",
    date: "2026-07-21",
    changes: [
      "Dokumenty: nová sekce s dokumenty připravenými k vyplnění a tisku.",
    ],
  },
  {
    version: "4.14.1",
  ...
  },
  {
    ...
    date: "2026-07-20",
    changes: [
      "Tabulky: nová sekce s pomocnými výpočtovými tabulkami.",
    ],
  },
  {
    version: "4.13.0",
    date: "2026-07-20",
    changes: [
      "Směny: drobná vylepšení pro administrátorskou stránku.",
    ],
  },
  {
    version: "4.12.3",
  ...
  },
  {
    ...
    date: "2026-07-17",
    changes: [
      "Hromadné generování dokumentů pro více zaměstnanců najednou.",
    ],
  },
  {
    version: "4.11.1",
    date: "2026-07-17",
    changes: [
      "Recepční účty se nyní nemůžou samy odhlásit.",
    ],
  },
  {
    version: "4.11.0",
